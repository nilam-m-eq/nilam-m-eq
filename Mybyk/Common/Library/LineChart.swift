...
open class LineChart: UIView
{
    ...
    */
    ...
    public struct Dots {
        public var visible: Bool = true
        public var color: UIColor = UIColor(named: "Color_Primary")!
    ...
    fileprivate var dotsDataStoreLabel: [[CATextLayer]] = []
    ...
    override open func draw(_ rect: CGRect) {
        ...
        // remove all Label on device rotation
        for dotsData in dotsDataStoreLabel {
            for dot in dotsData {
                dot.removeFromSuperlayer()
            }
        }
        dotsDataStoreLabel.removeAll()
    ...
    fileprivate func highlightDataPoints(_ index: Int) {
        for (lineIndex, dotsData) in dotsDataStore.enumerated() {
            ...
            dot.backgroundColor = UIColor(named: "Color_Primary")?.cgColor
            //
    ...
    fileprivate func drawDataDots(_ lineIndex: Int)
    {
      ...
      //  print(data)
        ...
        for index in 0..<data.count {
         ...
         //   print(self.dataStore[index])
          ...
          //   path.addLine(to: CGPoint(x: xValue, y: yValue))
             ...
             path.addLine(to: CGPoint(x: xValue, y: yValue - 40))
             */
            ...
            dotLayer.backgroundColor = UIColor(named: "Color_Primary")?.cgColor
            
            //dots.color.cgColor
            dotLayer.cornerRadius = dots.outerRadius / 2
            dotLayer.frame = CGRect(x: xValue, y: yValue - 40, width: dots.outerRadius, height: dots.outerRadius)
            self.layer.addSublayer(dotLayer)
            dotLayers.append(dotLayer)
            
           
            let textLayer = CATextLayer()
            textLayer.frame = CGRect(x: xValue, y: dotLayer.frame.minY - 10, width: 50, height: 15)
            textLayer.fontSize = 8
            textLayer.string = "\(data[index])"
            textLayer.foregroundColor = UIColor.black.cgColor
            textLayer.contentsScale = UIScreen.main.scale
            self.layer.addSublayer(textLayer)
       
            dotLayerLabel.append(textLayer)
            /*
        ...
        dotsDataStoreLabel.append(dotLayerLabel)
    }
    ...
    fileprivate func drawLine(_ lineIndex: Int) {
        ...
        path.move(to: CGPoint(x: xValue, y: yValue - 40))
        ...
        layer.strokeColor = UIColor(named: "Color_Primary")?.cgColor
        //colors[lineIndex].cgColor
        layer.fillColor = nil
...
class DotCALayer: CALayer {
    ...
    var dotInnerColor = UIColor(named: "Color_Primary")
    //UIColor.black
    ...
    override func layoutSublayers()
    {
      ...
      //  let inset1 = self.bounds.size.width - innerRadius
      //  let innerDotLayer1 = UILabel()
        //self.addSublayer(<#T##layer: CALayer##CALayer#>)
        //innerDotLayer1.frame = self.bounds.insetBy(dx: inset1/2, dy: inset1/2)
      //  innerDotLayer1.backgroundColor = dotInnerColor?.cgColor
      //  innerDotLayer1.cornerRadius = innerRadius / 2
       // self.addSublayer(innerDotLayer1)
    }
