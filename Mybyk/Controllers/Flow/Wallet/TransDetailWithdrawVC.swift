...
class TransDetailWithdrawVC: CommonViewController {
    @IBOutlet weak var viewBackDetail: UIView!
    @IBOutlet var lblTransactionID: UILabel!
    @IBOutlet var lblWithdrawAccount: UILabel!
...
// ************************************ //
extension TransDetailWithdrawVC {
    ...
    func setUIOnScreen() {
        ...
        lblAmount.text = "₹ \(transModel.dataArr[indexPath.row].total_amount ?? "")"
